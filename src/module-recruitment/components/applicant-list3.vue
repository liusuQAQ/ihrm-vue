      ...
      <div>
        ...
        <div class="userInfo">
          ...
          <el-table :data="dataList" border fit highlight-current-row style="width:100%; margin-top:10px;">
                ...
                <el-table-column sortable prop="mobile" label="电话" width="150"></el-table-column>
                ...
                <el-table-column sortable  label="通过状态" width="150">
                  <template slot-scope="scope">
                    <el-tag v-if="scope.row.offer == 0" type="info">未开始</el-tag>
                    <el-tag v-if="scope.row.offer == 1" type="success">通过</el-tag>
                    <el-tag v-if="scope.row.offer == 2" type="danger">未通过</el-tag>
                  </template>
    ...
    <el-dialog title="编辑岗位" :visible.sync="dialogFormVisible" style="hight:100px;line-height:1px">
      <el-form :model="formData" label-width="90px" style="margin-top:20px">
        ...
        <el-form-item label="状态">
          <!-- 过程状态 -->
        <el-select disabled v-model="formData.progressState" placeholder="过程状态" style="width: 40%;">
          <el-option
        ...
        <!-- 通过状态 -->
        <el-select disabled v-model="formData.passState" placeholder="通过状态" style="width: 50%;">
          <el-option
        ...
        <!-- 发offer -->
        <el-form-item label="同意入职">
          <el-select v-model="formData.offer" placeholder="同意入职" style="width: 40%;">
          <el-option
            v-for="item in offer"
            :key="item.value"
            :label="item.label"
